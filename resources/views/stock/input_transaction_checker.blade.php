...
<div class="container">
  <div class="row">
    ...
    <div class="box box-primary">
        <div class="box-body">
        <big><big><big>
          <font face='calibri'><b>INPUT AMOUNT FOR CHECKER</b></font>
        </big></big></big>
      </div>
          <div class="panel-body"> 
            <form class="form-horizontal" role="form" enctype='multipart/form-data' method="POST" action="{{ url('/stock/save_transaction_checker') }}">
              ...
              <div class="form-group">
                <div class="col-md-3">
                  ...
                  @if ($t_transaction->amount_box_checker == "0") 
                  <input type="number" class="form-control" name="amount_box" min="0" id="amount_box" placeholder="{{$t_transaction->amount_box_checker}}" autofocus>
                  @else
                  <input type="number" class="form-control" name="amount_box" min="0" id="amount_box" value="{{$t_transaction->amount_box_checker}}" autofocus>
                  @endif
                </div>
              </div> 
              @endif
              <div class="form-group">
                <div class="col-md-3">
                  ...
                  <input type="number" min="0" lass="form-control" name="amount_pcs"  id="amount_pcs" placeholder="{{$t_transaction->amount_pcs_checker}}">
                  @else
                  <input type="number" min="0" class="form-control" name="amount_pcs"  id="amount_pcs" value="{{$t_transaction->amount_pcs_checker}}">
                  @endif
                </div>
              </div>
              <div class="form-group">

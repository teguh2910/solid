            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active">
                        ...
                        <big><big><big><b>LIST INVOICE USER
                        <span class='badge badge-info'></span></b></font></big></big></big>
                        </a>
                    </li>
                    <li>
                ...
                <div class="tab-content">
                    ...
                    @if (count($invoice) > 0)
                        @foreach ($invoice as $invoice)
                            ...
                            <td class='warning'>
                                <a href="{{ url('invoice/receive/acc/'.$invoice->id) }}" class="btn btn-primary btn-xs" 

        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"> 
                        <a href="{{ url('/invoice/receive/acc') }}">
                            <font face='calibri' color='grey'>
                    ...
                    <li>
                        <a href="{{ url('/invoice/send/acc') }}">
                            <font face='calibri' color='grey'><b>INVOICE DIKIRIM
                                <span class='badge badge-info'></span></b></font>
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('invoice/reject/acc') }}">
                ...
                <div class="tab-content">
                    ...
                    @if (count($invoice) > 0)
                        @foreach ($invoice as $invoice)
                            ...
                            <td class='warning'>
                                <a href="{{ url('invoice/send/acc/'.$invoice->id) }}" class="btn btn-primary btn-xs" 
                                    onclick="return confirm('Apakah anda yakin')">
                                    <font face='calibri'><b>Kirim ke Tax</b></font>
                                </a>&nbsp;
                                <a href="{{ url('invoice/send/acc/fin'.$invoice->id) }}" class="btn btn-primary btn-xs" 
                                    onclick="return confirm('Apakah anda yakin')">
                                    <font face='calibri'><b>Kirim ke Fin</b></font>
                                </a>&nbsp;
                                <a href="{{ url('invoice/reject/acc/'.$invoice->id) }}" class="btn btn-danger btn-xs"
                                    onclick="return confirm('Apakah anda yakin')">

            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active">
                        ...
                        <big><big><big><b>LIST INVOICE CASHIER
                ...
                <div class="tab-content">
                    ...
                    <form method="post" action="{{ url('invoice/receive/user') }}">
                    ...
                    @if (count($invoice) > 0)
                        @foreach ($invoice as $invoice)
                            ...
                            <td class='warning'>
                                <!-- <a href="{{ url('invoice/receive/user/'.$invoice->id) }}" class="btn btn-primary btn-xs" 

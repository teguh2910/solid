                ...
                <div class="tab-content">
                    ...
                    @if (count($invoice) > 0)
                        @foreach ($invoice as $invoice)
                            ...
                            <td class='warning'>
                                <a href="{{ url('invoice/receive/fin/'.$invoice->id) }}" class="btn btn-primary btn-xs" 
                                    onclick="return confirm('Apakah anda yakin')">
                                    <font face='calibri'><b>Terima</b></font>
                                </a>&nbsp;
                                <a href="{{ url('invoice/reject/fin/'.$invoice->id) }}" class="btn btn-danger btn-xs"
                                    onclick="return confirm('Apakah anda yakin')">

        ...
        <div class="col-md-12">
            ...
            @if (count($invoice) > 0)
                ...
                <?php 
                    ...
                    <td class='warning'>
                        <center>
                            <a href="{{ url('invoice/checked/fa/'.$invoice->id) }}" class="btn btn-info btn-flat btn-xs" onclick="return confirm('Are you sure to checked invoice with no penerimaan \'{{$invoice->no_penerimaan}}\' ?')">
                                <font face='calibri'><b>Checked</b></font>
                            </a>&nbsp;
                            <a href="{{ url('invoice/reject/fa/'.$invoice->id) }}" class="btn btn-danger btn-flat btn-xs" onclick="return confirm('Are you sure to reject invoice with no penerimaan \'{{$invoice->no_penerimaan}}\' ?')">

                ...
                <div class="tab-content">
                    ...
                    @if (count($invoice) > 0)
                        @foreach ($invoice as $invoice)
                            ...
                            <td><font face='calibri'>{{ $invoice->status()->first()->keterangan }}</font></td>
                            @if(\Auth::user()->role == 0)
                            <td class='warning'>
                                <center>
                                    <a href="{{ url('invoice/update/'.$invoice->id) }}" class="btn btn-xs btn-success"><font face='calibri'><b>Edit</b></font></a>
                                    <a href="{{ url('invoice/delete/'.$invoice->id) }}" class="btn btn-xs btn-danger"><font face='calibri'><b>Delete</b></font></a>
                                </center>
                            </td>
                            @endif
                        </tr>
